...
export const Footer = (props) => {
  ...
  return (
    <footer className="relative w-full border-t">
      ...
      <div className="text-gray-500 container mx-auto max-w-4xl py-6 md:flex flex-wrap md:flex-no-wrap md:justify-between items-center text-sm">
        ...
        <div className="md:p-0 text-center md:text-right text-xs">
          ...
          <span className="no-underline ml-4">
            ...
            <a href="https://vercel.com" className="hover:underline">
              {' '}
              Vercel
              <VercelIcon className="inline-block w-4 h-4 ml-1" />
            </a>
          </span>
        </div>
      </div>
